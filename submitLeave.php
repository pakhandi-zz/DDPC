...
$query = "SELECT sem_no, sem_type FROM studentregistration WHERE `reg_no` = '$reg_no'";
		...
		$year = "2016";
$approved = 0;
$query = "INSERT INTO `groupx`.`leave` (`reg_no`, `leave_type`, `sem_no`, `sem_type`, `academic_year`, `from_date`, `to_date`, `no_of_days`, `approved`, `address`, `applied_on`) VALUES ('$reg_no', '$leave_type', '$sem_no', '$sem_type', '$year', '$from', '$to', '$days', '$approved', '$address', '$applied_on')";
