											...
											<div class="row">
												<div class="col-md-3">
													<div class="form-group">
														...
														<select name="leave_type" class="required form-control border-input" >
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control border-input" id="from_datepicker" name="from_datepicker"/>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>To Date</label>
														<input type="text" class="form-control border-input" id="to_datepicker" name="to_datepicker"/>
													</div>
												</div>
											</div>
